    ...
    >
      <div className="carousel-inner p-0 h-60 px-0" >
        ...
        <div className="carousel-item">
          <img src='http://stage.saiproperties.co.in/front-images/home2.jpg' className="d-block w-100 h-60" alt="img slider" />
        </div>
        <div className="carousel-item">
          <img src='http://stage.saiproperties.co.in/front-images/home3.jpg' className="d-block w-100" alt="img slider" />
        </div>
        <div className="carousel-item">
          <img src='http://stage.saiproperties.co.in/front-images/home5.jpg' className="d-block w-100" alt="img slider" />
        </div>
      </div>
    </div>
  );
