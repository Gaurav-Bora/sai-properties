...
const MainFooter = () => {
  return (
    ...
    <div className="d-flex justify-content-center align-items-center mb-3">
        ...
        <a href="https://www.facebook.com/profile.php?id=100067943470567" target="_blank" rel="noopener noreferrer" className="mx-2">
    ...
    <FaRegCopyright size={20} /> {new Date().getFullYear()} SAI PROPERTIES. ALL RIGHTS RESERVED
</div>
