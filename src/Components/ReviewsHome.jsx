...
const ReviewsHome = () => {
  return (
    <div className="text-center shadingBg" style={{ padding: '20px' }}>
      <p className="mb-4 headingReview">Reviews</p>
